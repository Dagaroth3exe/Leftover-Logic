  ...
  return (
    <div className="fixed inset-0 bg-black/65 backdrop-blur-md flex justify-center items-center z-50 p-4">
      <div className="w-full max-w-2xl relative">
        ...
        <div className="bg-zinc-900 border border-[#3179FF]/25 rounded-2xl overflow-hidden shadow-2xl max-h-[88vh] flex flex-col">
          {/* Header */}
          <div className="bg-gradient-to-r from-[#3179FF]/15 to-transparent px-6 py-5 border-b border-[#3179FF]/15 flex-shrink-0">
            <div className="flex items-center justify-between mb-3">
              <span className="px-3 py-1 rounded-full bg-[#3179FF]/15 border border-[#3179FF]/35 text-[#7AADFF] text-xs font-bold">
                🇮🇹 Italian
              </span>
              <button
                onClick={copyRecipe}
          ...
          <div className="px-6 py-5 overflow-y-auto">
            <p className="text-gray-400 italic mb-6 text-sm leading-relaxed border-l-2 border-[#3179FF]/40 pl-4">
              {data.description}
            </p>

            <h3 className="text-[#6090FF] font-semibold text-xs uppercase tracking-widest mb-4">
              Instructions
            </h3>
            ...
            <ol className="space-y-4 pb-2">
              {steps.map((step, i) => (
                <li key={i} className="flex gap-4 text-gray-300 text-sm leading-relaxed">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#3179FF]/15 border border-[#3179FF]/30 text-[#7AADFF] text-xs font-bold flex items-center justify-center mt-0.5">
                    {i + 1}
                  </span>
